...
#define CONFIG_SYS_PROMPT			"s5p4418_rookie# "
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"bootargs=console=ttyAMA0,115200n8 root=/dev/mmcblk0p3 rw rootfstype=ext4 loglevel=4 rootwait quiet " \
	...
	"mmcboot=run boot_cmd_mmcboot \0"           \
        ...
        "ramfsboot=setenv bootargs console=ttyAMA0,115200n8 " \
